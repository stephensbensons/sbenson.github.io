 ...
 */
//
//use Array.isArray to test if value is an array
//then return it 
 ...
 * with typeof.
 */
//use an if else statement to determine whether the value is an object but also not null, a date, or an array
 ...
 */
//use an if/else staement to check whether the value is an array or object
//use keywords for array and object and check to make sure it's not null and not a date
